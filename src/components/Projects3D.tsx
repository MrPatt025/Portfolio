...
import { ProjectsShowcase3D } from "./3d/ProjectsShowcase3D"
...
const Projects3D = () => {
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-br from-secondary/20 via-background to-primary/5 relative overflow-hidden">
      {/* Background 3D Scene */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            A showcase of innovative solutions spanning AI, automation, and cutting-edge development tools
          </p>
        </motion.div>

        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          {/* Interactive 3D Projects Display */}
          <motion.div
          ...
          >
            <div className="relative w-full h-full glass-effect rounded-2xl overflow-hidden border border-primary/20">
              ...
              <div className="absolute top-4 left-4 right-4 bg-background/80 backdrop-blur-sm rounded-lg p-3">
                <p className="text-sm text-muted-foreground text-center">
                  🎯 Hover over projects to explore • 🖱️ Drag to rotate • 🔍 Zoom for details
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="card-hover h-full overflow-hidden glass-effect border-primary/20 hover-lift">
                {/* Project Image */}
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <Badge className={`${getStatusColor(project.status)} flex items-center gap-1 glass-effect`}>
                      {getStatusIcon(project.status)}
                      {project.status}
                    </Badge>
                  </div>
                  <div className="absolute bottom-4 left-4">
                    <Badge variant="secondary" className="glass-effect">{project.category}</Badge>
                  </div>
                </div>
                ...
                <CardContent className="space-y-6">
                  {/* Technologies */}
                  <div>
                    <h4 className="font-semibold mb-2 text-accent">Tech Stack</h4>
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech) => (
                        <Badge key={tech} variant="outline" className="text-xs hover-lift">
                          {tech}
                        </Badge>
                      ))}
                    </div>
                  ...
                  <div className="flex gap-2 pt-4">
                    {project.links.github && (
                      <Button variant="outline" size="sm" className="hover-lift glass-effect" asChild>
        ...
        >
          <Button variant="outline" size="lg" className="hover-lift glass-effect" asChild>
